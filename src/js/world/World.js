/** @typedef {import('../core/InfoStack').InfoStack} InfoStack */
/** @typedef {import('../interfaces/IWorldEntity').IWorldEntity} IWorldEntity */
/** @typedef {import('../interfaces/IUpdatable').IUpdatable} IUpdatable */
...
export class World {
    ...
    /**
     * @public
     * @param {IWorldEntity} worldEntity
     * @returns {void}
     */
    add(worldEntity) {
