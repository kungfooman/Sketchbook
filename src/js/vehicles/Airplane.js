...
export class Airplane extends Vehicle {
    /**
     * @public
     * @default EntityType.Airplane
     */
    entityType = EntityType.Airplane;
    /**
     * @public
     */
    rotor;
    ...
    update(timeStep) {
        ...
        if (this.controllingCharacter !== undefined) {
            if (this.enginePower < 1)
                this.enginePower += timeStep * 0.4;
            if (this.enginePower > 1)
                this.enginePower = 1;
        }
        else {
            if (this.enginePower > 0)
                this.enginePower -= timeStep * 0.12;
            if (this.enginePower < 0)
                this.enginePower = 0;
        }
